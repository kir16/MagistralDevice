...
namespace MagistralDevice.DataClasses
{
  ...
  public sealed class dxCommand
  {
    ...
    public dxCommand(dxDeviceAttributes attributes) {
    ...
    public dxCommand(dxDeviceAttributes attributes, dxParameterList parameters) {
      Attributes = new dxDeviceAttributes()
                   {
                     Name = attributes?.Name
                   , Serial = attributes?.Serial
      ...
      Parameters = new dxParameterList();
      if( Parameters?.ParameterItem != null && parameters?.ParameterItem != null ) {
        Parameters.ParameterItem.AddRange(parameters.ParameterItem);
      }
    }

    public dxCommand(dxParameterList parameters) {
      Parameters = new dxParameterList();
      if( Parameters?.ParameterItem != null && parameters?.ParameterItem != null ) {
        Parameters.ParameterItem.AddRange(parameters.ParameterItem);
      }
