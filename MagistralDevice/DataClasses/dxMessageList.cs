...
[XmlRootAttribute(ElementName="MessageList")]
public class dxMessageList
{
    #region Private fields
    private List<dxMessage> _messageItem;
    ...
    {
        _messageItem = new List<dxMessage>();
    }
    ...
    private static XmlSerializer Serializer
    {
        get
        {
            if ((serializer == null))
            {
                serializer = new XmlSerializerFactory().CreateSerializer(typeof(dxMessageList));
    ...
    {
        return ((dxMessageList)(Serializer.Deserialize(s)));
    }
    #endregion
    ...
    /// </summary>
    public virtual dxMessageList Clone()
    {
