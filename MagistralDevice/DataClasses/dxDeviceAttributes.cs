...
[XmlRootAttribute(ElementName="DeviceAttributes")]
public class dxDeviceAttributes
{
    ...
    private static XmlSerializer Serializer
    {
        get
        {
            if ((serializer == null))
            {
                serializer = new XmlSerializerFactory().CreateSerializer(typeof(dxDeviceAttributes));
    ...
    /// <summary>
    /// Serializes current dxDeviceAttributes object into an XML string
    /// </summary>
    ...
    /// <summary>
    /// Deserializes workflow markup into an dxDeviceAttributes object
    /// </summary>
    /// <param name="input">string workflow markup to deserialize</param>
    /// <param name="obj">Output dxDeviceAttributes object</param>
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool Deserialize(string input, out dxDeviceAttributes obj, out Exception exception)
    {
        exception = null;
        obj = default(dxDeviceAttributes);
        try
        {
    ...
    /// <summary>
    /// Serializes current dxDeviceAttributes object into file
    /// </summary>
    ...
    /// <summary>
    /// Deserializes xml markup from file into an dxDeviceAttributes object
    /// </summary>
    /// <param name="fileName">string xml file to load and deserialize</param>
    /// <param name="obj">Output dxDeviceAttributes object</param>
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out dxDeviceAttributes obj, out Exception exception)
    {
        exception = null;
        obj = default(dxDeviceAttributes);
        try
    ...
    public static dxDeviceAttributes LoadFromFile(string fileName)
    {
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this dxDeviceAttributes object
    /// </summary>
    public virtual dxDeviceAttributes Clone()
    {
        return ((dxDeviceAttributes)(MemberwiseClone()));
    }
    #endregion
}
}
